...
angular.module('BeehivePortal')
  .controller('UserThingAuthorityController', ['$scope', '$rootScope', '$state', 'AppUtils', '$timeout', '$$Thing', '$$Tag', '$q', '$$Location', function($scope, $rootScope, $state, AppUtils, $timeout, $$Thing, $$Tag, $q, $$Location) {
