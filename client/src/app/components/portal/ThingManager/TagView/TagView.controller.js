  ...
  .controller('TagViewController', ['$scope', '$rootScope', '$state', 'AppUtils', '$$Tag', '$$Thing','$uibModal', '$q', '$http',function($scope, $rootScope, $state, AppUtils, $$Tag, $$Thing, $uibModal, $q, $http) {
    ...
    $scope.addTag = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'app/components/portal/ThingManager/TagView/AddTag.template.html',
    ...
    $scope.editTag = function(tag){
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'app/components/portal/ThingManager/TagView/EditTag.template.html',
