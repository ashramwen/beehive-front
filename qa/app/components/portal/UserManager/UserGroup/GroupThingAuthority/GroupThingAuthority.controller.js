...
angular.module('BeehivePortal')
  .controller('GroupThingAuthorityController', ['$scope', '$rootScope', '$state', 'AppUtils', '$timeout', '$$Thing', '$$Tag', '$q', '$$Location', function($scope, $rootScope, $state, AppUtils, $timeout, $$Thing, $$Tag, $q, $$Location) {
